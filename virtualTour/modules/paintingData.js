export const paintingData = [
  ...
  ...Array.from({ length: 4 }, (_, i) => ({
    ...
    info: {
      ...
      title: `General People receiving training`,
  ...
  ...Array.from({ length: 4 }, (_, i) => ({
    ...
    rotationY: Math.PI,
    info: {
      title: `Martyrs of Liberation War`,
  ...
  ...Array.from({ length: 4 }, (_, i) => ({
    ...
    rotationY: Math.PI / 2,
    info: {
      title: `Newspaper Clippings at the time of Liberation War`,
  ...
  ...Array.from({ length: 4 }, (_, i) => ({
    ...
    rotationY: -Math.PI / 2,
    info: {
      title: `Victory day of Liberation War`,
